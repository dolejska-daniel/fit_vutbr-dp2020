...
def run():
    with open("../data/captcha_1.txt", "r") as f:
        c = "".join(f.readlines())
    ...
    img = plt.imread("../data/captcha_1.png")
    ax.imshow(img)
    ...
    plt.savefig("../../build/point_clustering_1_raw.pdf", bbox_inches="tight")
    ...
    plt.savefig("../../build/point_clustering_1.pdf", bbox_inches="tight")
